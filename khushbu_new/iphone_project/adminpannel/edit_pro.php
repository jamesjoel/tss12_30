...
<div id="content">
	...
	<table align="center">
		...
		<tr>
			...
			<td><select class="input" name="product_category">
		...
		<tr>
			...
			<td><input name="product_discount" type="Text"  class="input" value="<?php echo $data_pro['product_discount'];?>" /></td>
		</tr>
		<tr>
