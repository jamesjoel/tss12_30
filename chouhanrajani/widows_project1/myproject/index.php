...
?>
				...
				?>
					...
					<div class="right-block1">
						<img height="140" width="100" src="upload/<?php echo $data_pro['product_img']; ?>">
					</div>
					<div class="right-block2">
						...
						<p><a href="view_more.php?pid=<?php echo $data_pro['id']; ?>"class="view-more-btn">View</a></p>
						<p><a href="add_to_cart.php?pid=<?php echo $data_pro['id']; ?>" class="view-more-btn">Add To Cart</a>
					</div>	
					</div>
	<?php 
			}
