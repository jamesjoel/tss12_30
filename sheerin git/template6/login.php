         ...
         <tr>   
            ...
            <tr><td colspan="2" align="center">
                 <input type="submit" name="save" value="login" >                 
                  ...
                  <a style="color: buttontext;border-color: buttonface;font-size: 16px; text-align:center; border-width: 1px;padding: 1px 6px; border-style:outset; background-color: buttonface;" href="index.html">cancel</a>
                </td>
        </tr>
    </table>
</form>
